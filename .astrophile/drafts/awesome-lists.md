...
- awesome AI-agent / LLM-tooling lists (awesome-ai-agents, awesome-llm-tools, awesome-mcp: `hwatu mcp` is the entry point) — primary
- awesome-rust
- ecosystem lists for the WM niche (e.g. awesome-wayland, awesome-hyprland) — secondary
